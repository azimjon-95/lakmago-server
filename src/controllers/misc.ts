...
import { AuthRequest, signToken, verifyTelegramInitData } from '../middleware/auth.js';
...
export const authController = {
  ...
  telegram: asyncHandler(async (req: Request, res: Response) => {
    ...
    const tgUser = JSON.parse(data.user ?? '{}') as TelegramWebAppUser;
...
export const orderController = {
  ...
  updateStatus: asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    // Telegram push
    const user = order.userId as unknown as { telegramId?: string };
